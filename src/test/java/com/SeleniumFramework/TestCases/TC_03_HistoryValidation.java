...
public class TC_03_HistoryValidation  extends BaseTest{
	
	@Test(groups= {"sanity"})	
	public void History_Validation() {
		...
		//History validation
		HistoryPage historyPage = ConfirmationPage.ClickOnHomePage();		
		historyPage.SelectHistory();
		Assert.assertTrue(historyPage.getDateInHistory().contains(ConstantsHelper.date));
